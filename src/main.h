...
extern Pair tiles_alive_state[];    // This array contains coordinates of all alive cells
extern Pair tiles_neear_alive_state[]; // This array contains coordinates of all the cells that are neighbours of alive cells
